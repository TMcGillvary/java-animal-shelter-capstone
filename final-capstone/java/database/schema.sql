...
insert into applications (application_status_id, name, email, phone, description) values ('1', 'Haleigh Jenny', 'hjenny0@linkedin.com', '588-610-3567', 'Phasellus sit amet erat. Nulla tempus. Vivamus in felis eu sapien cursus vestibulum.');
insert into applications (application_status_id, name, email, phone, description) values ('1', 'Tracey Sharman', 'tsharman1@mediafire.com', '913-406-5850', 'Proin leo odio, porttitor id, consequat in, consequat ut, nulla. Sed accumsan felis. Ut at dolor quis odio consequat varius.');
insert into applications (application_status_id, name, email, phone, description) values ('1', 'Peggy Ivanisov', 'pivanisov2@mtv.com', '222-841-1909', 'Duis aliquam convallis nunc. Proin at turpis a pede posuere nonummy. Integer non velit.');
insert into applications (application_status_id, name, email, phone, description) values ('1', 'Manon Skeats', 'mskeats3@infoseek.co.jp', '185-402-4876', 'Quisque id justo sit amet sapien dignissim vestibulum. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nulla dapibus dolor vel est. Donec odio justo, sollicitudin ut, suscipit a, feugiat et, eros.');
insert into applications (application_status_id, name, email, phone, description) values ('1', 'Kev MacCroary', 'kmaccroary4@nyu.edu', '927-329-0188', 'In quis justo. Maecenas rhoncus aliquam lacus. Morbi quis tortor id nulla ultrices aliquet.');
